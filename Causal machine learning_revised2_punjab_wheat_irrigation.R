...
library(haven)
data <- read_dta('LLL Punjab plot data_revised2_paper1_adoption3_wheat_irrigation.dta')
...
frequency_outcome_errorplot=
  ...
  ggerrorplot(x = "treat_lll_new", y = "plot_irri_hrs_wheat_ha",add = "mean", error.plot = "errorbar", color="black",size=1, ggtheme=theme_bw(), stat = "summary", fun.data = "mean_cl_boot")+
  labs(x="Frequency of adoption",y="Wheat irrigation (h/ha)")+
...
ls(data_desc)
library(fBasics)
summ_stats <- fBasics::basicStats(data[,c("age_hhmember", "edun_hhmember", "total_num_adult_members_HH", "women_share", "asset_index", "plot_area_ha", "plot_dist_lll", "num_plot", "sp_lll_new", "datairrwater_tbl_21","simpson_index_kh", "simpson_index_rb", "datadstdst_dhq", "_Iaccess_fa_1", "_Iaccess_go_1","_Iaccess_in_1", "_Iaccess_kv_1" , "_Iaccess_ng_1", "_Iaccess_pr_1", "_Icaste_cat_2", "_Iplot_soil_2", "_Iplot_wate_1", "_Ireligion__1")])
...
factor_varibales <-c("levelled_2021", "caste_cat2",  "religion_new",  "non_farm_binary", "plot_soiltype2", "plot_soilfertility", "plot_erosionprobl", "plot_waterloggprob", "subsidy_lll", "access_govt_ext" , "access_kvk", "access_prog_farmer", "access_ngo", "access_farmer_grp", "access_input_dealer")
...
Y_cf_freq=as.vector(data$plot_irri_hrs_wheat_ha)
#Y_cf_freq =na.omit(Y_cf_freq)
has_na <- anyNA(Y_cf_freq)
print(has_na)

# Fit regression forest irrigation saving
...
data=subset(data, select=c("plot_irri_hrs_wheat_ha","treat_lll_new","caste_cat2",  "religion_new",  "non_farm_binary", "plot_soiltype2", "plot_soilfertility", "plot_erosionprobl", "plot_waterloggprob", "access_govt_ext" , "access_kvk", "access_prog_farmer", "access_ngo", "access_farmer_grp", "access_input_dealer", "age_hhmember", "edun_hhmember", "total_num_adult_members_HH", "women_share", "asset_index", "plot_area_ha", "subsidy_lll", "num_plot", "sp_lll_new", "datairrwater_tbl_21","simpson_index_kh", "simpson_index_rb", "datadstdst_dhq","levelled_2021","district_name_new_num","HD3086","N_use", "pump_hp"))
library(tidyr)
data=data%>% drop_na()

Y_cf_freq=as.vector(data$plot_irri_hrs_wheat_ha)

X_cf_freq=subset(data, select=c("caste_cat2",  "religion_new",  "non_farm_binary", "plot_soiltype2", "plot_soilfertility", "plot_erosionprobl", "plot_waterloggprob", "access_govt_ext" , "access_kvk", "access_prog_farmer", "access_ngo", "access_farmer_grp", "access_input_dealer", "age_hhmember", "edun_hhmember", "total_num_adult_members_HH", "women_share", "asset_index", "plot_area_ha", "subsidy_lll", "num_plot", "sp_lll_new", "datairrwater_tbl_21","simpson_index_kh", "simpson_index_rb", "datadstdst_dhq", "district_name_new_num","HD3086","N_use", "pump_hp"))
